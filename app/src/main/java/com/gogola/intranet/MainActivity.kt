...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navBar.getTabAt(1)?.setIcon(R.drawable.ic_notes)
        navBar.getTabAt(2)?.setIcon(R.drawable.ic_person)
        navBar.getTabAt(3)?.setIcon(R.drawable.ic_search)
        navBar.getTabAt(4)?.setIcon(R.drawable.ic_groups)
    }
}